...
title: Next Movies
rank: 2
summary: A web app where you can browse and search for movies and tv shows
source: https://github.com/iSDestiny/next-movies
live: https://next-movies-ashy.vercel.app/
stack: [Typescript, React, Next, Chakra UI, SWR, Framer Motion]
images:
    [
        {
            src: '/static/images/next-movies/home-light.png',
            alt: 'Home page light mode'
        },
        {
            src: '/static/images/next-movies/home-dark.png',
            alt: 'Home page dark mode'
        },
        {
            src: '/static/images/next-movies/home-mobile-light.png',
            alt: 'Home page light mode mobile',
            type: 'mobile'
        },
        {
            src: '/static/images/next-movies/browse-light.png',
            alt: 'Browse page light mode'
        },
        {
            src: '/static/images/next-movies/browse-dark.png',
            alt: 'Browse page dark mode'
        },
        {
            src: '/static/images/next-movies/browse-dark-mobile.png',
            alt: 'Browse page dark mode mobile',
            type: 'mobile'
        },
        {
            src: '/static/images/next-movies/movie-light.png',
            alt: 'Movie page light mode'
        },
        {
            src: '/static/images/next-movies/movie-light-mobile.png',
            alt: 'Movie page light mode mobile',
            type: 'mobile'
        },
        {
            src: '/static/images/next-movies/search-light.png',
            alt: 'Search page light mode'
        },
        {
            src: '/static/images/next-movies/genre.png',
            alt: 'Genre page dark mode'
        },
        {
            src: '/static/images/next-movies/genre-light-mobile.png',
            alt: 'Genre page light mode mobile',
            type: 'mobile'
        },
        {
            src: '/static/images/next-movies/person-dark.png',
            alt: 'Person page dark mode'
        },
        {
            src: '/static/images/next-movies/person-light-mobile.png',
            alt: 'Person page light mode mobile',
            type: 'mobile'
        }
    ]
---
