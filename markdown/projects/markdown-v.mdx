...
images:
    [
        { src: 'https://i.imgur.com/5OuZY7r.png', alt: 'markdownv app' },
        {
            src: 'https://i.imgur.com/PNwUMpj.png',
            alt: 'markdownv app fuzzy search'
        },
        { src: 'https://i.imgur.com/WN2Hm6z.png', alt: 'markdownv home page' },
        { src: 'https://i.imgur.com/UBMQdwy.png', alt: 'markdownv login page' }
    ]
---
